...
const CustomCursor = () => {
  ...
  return (
    <div
      ...
      aria-hidden="true"
    >
      <div ref={dot} className="w-2 h-2 bg-white rounded-full absolute top-0 left-0 -translate-x-1/2 -translate-y-1/2" />
      <div ref={ring} className="w-12 h-12 border border-white/30 rounded-full absolute top-0 left-0 -translate-x-1/2 -translate-y-1/2" />
    </div>
  );
};
